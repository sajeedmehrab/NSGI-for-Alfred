...
def save_model(Generator, gen_optimizer, i):
    SAVE_FILE = '/home/tpriya/CS6604/Multimodal-Graph-Script-Learning/model' + "NonSeqF" + '_' + str(i) + 'epochs.tar'
...
def train_eval_loop(Generator, tokenizer, SEP_GROUNDED_CONTRASTIVE_DATA, NEW_GROUNDED_DATA, WIKIHOW_INPUT_DATA, WIKIHOW_REFERENCE_GROUP, mini_batch_size, accum_iter,train_steps, EPOCHS):
    ...
    #Update
    dis_optimizer = torch.optim.Adam(Generator.parameters(), lr=2e-5)
...
def main():
    ...
    checkpoint = torch.load('/home/tpriya/CS6604/Multimodal-Graph-Script-Learning/model/NonSeq_5epochs.tar', map_location=torch.device('cpu'))
    Generator.load_state_dict(checkpoint['generator_state_dict'])

    #Update
    # load data
    with open("/home/tpriya/CS6604/Multimodal-Graph-Script-Learning/data/crosstask_wikihow_reference_step_libraries.json", "r") as fp:
        WIKIHOW_REFERENCE_GROUP = json.load(fp)
    with open("/home/tpriya/CS6604/Multimodal-Graph-Script-Learning/data/crosstask_wikihow_input_sequences.json", "r") as fp:
        WIKIHOW_INPUT_DATA = json.load(fp)
    with open("/home/tpriya/CS6604/Multimodal-Graph-Script-Learning/data/crosstask_wikihow_output_sequences.json", "r") as fp:
    ...
    Generator, gen_optimizer= train_eval_loop(Generator,bart_tokenizer, SEP_GROUNDED_CONTRASTIVE_DATA, SEP_GROUNDED_DATA, WIKIHOW_INPUT_DATA, WIKIHOW_REFERENCE_GROUP, 1, 2,  4, 2)
