...
if __name__ == '__main__':
    ...
    MODEL_CHECKPOINT = "/home/tpriya/CS6604/Multimodal-Graph-Script-Learning/modelNonSeqF_0epochs.tar"
    OUTPUT_DIR = '/home/tpriya/CS6604/Multimodal-Graph-Script-Learning/model/out/'
    os.mkdir(OUTPUT_DIR)
    set_seed(42)
    ...
    for group in MATCHED_PATHS:
        COUNTED_GROUP = []
        for pair in group:
            if len(pair) == 1:
                print("#########Continue##########")
                continue
            print(group.count(pair)/NUM_BEAMS)
