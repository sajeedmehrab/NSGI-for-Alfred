...
def save_model(Generator, gen_optimizer, i):
    MODEL_NAME="NonSeq"
    s = '/home/tpriya/CS6604/Multimodal-Graph-Script-Learning/model/'+ MODEL_NAME + '_' + str(i) + 'epochs.tar'
...
def main():
    ...
    #Update
    with open("/home/tpriya/CS6604/Multimodal-Graph-Script-Learning/data/ht100m_wikihow_input_sequences.json", "r") as fp:
        WIKIHOW_INPUT_DATA = json.load(fp)
    with open("/home/tpriya/CS6604/Multimodal-Graph-Script-Learning/data/ht100m_wikihow_output_sequences.json", "r") as fp:
    ...
    #Update
    Generator, gen_optimizer = train_eval_loop(Generator, bart_tokenizer, OUTPUT_WITH_SEP, INPUT_WITH_SEP, mini_batch_size = 1, accum_iter = 16, train_steps = 400, EPOCHS = 1)
